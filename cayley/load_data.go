...
func ImportDataToDB() {
	...
	cmd := exec.Command("cayley", "load", "--db=bolt", "--dbpath=../cayley.db", "--load=../data/social_network_10000.rdf.gz")
	// cmd := exec.Command("cayley", "load", "--db=bolt", "--dbpath=../cayley.db", "--load=../data/30kmoviedata.nq.gz")
